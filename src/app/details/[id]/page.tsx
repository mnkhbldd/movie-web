        ...
        <div className="flex flex-col gap-[32px] w-[1080px]">
          <div className="flex w-full justify-between">
            <div className="flex flex-col gap-2">
              <Skeleton className="w-[211px] h-[72px] bg-gray-400" />
              <Skeleton className="w-[237px] h-[28px] bg-gray-400" />
            </div>
            <div>
              <Skeleton className="w-[83px] h-[20px] bg-gray-400" />
              <Skeleton className="w-[83px] h-[20px] bg-gray-400" />
              <Skeleton className="w-[83px] h-[20px] bg-gray-400" />
            </div>
          </div>
          <div className="flex w-full gap-[32px]">
            <Skeleton className="w-[290px] h-[428px] bg-gray-400" />

            <div className="relative">
              <Skeleton className="w-[760px] h-[428px] bg-gray-400" />
            </div>
          </div>
          <div className="flex w-full flex-col gap-[20px]">
            <div className="flex gap-3">
              {[1, 2, 3, 4, 5].map((_, index) => (
                <Skeleton
                  key={index}
                  className="w-[51px] h-[22px] bg-gray-400"
                />
              ))}
            </div>
            <Skeleton className="w-full h-[72px] bg-gray-400" />
          </div>
          <div className="w-full flex gap-[32px] px-[80px] !p-0">
            {[1, 2, 3, 4, 5].map((_, index) => {
              return (
                <Skeleton
                  key={index}
                  className="w-[190px] h-[372px] bg-gray-400"
                />
              );
            })}
          </div>
